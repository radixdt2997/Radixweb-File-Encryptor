        ...
        <div className="space-y-6">
            ...
            >
                <div className="space-y-4">
                    <Input
                        ...
                        hint={
                            file ? `Selected: ${file.name}` : 'Choose a file to encrypt or decrypt'
                        }
            ...
            <Card className="bg-yellow-900/20 border-yellow-700">
                <p className="text-xs text-yellow-200">
                    ⚠️ Legacy mode uses a shared password. For better security and passwordless
                    access, prefer the OTP-based sharing flow.
                </p>
            </Card>
        </div>
    );
