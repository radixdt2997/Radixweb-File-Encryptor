...
function ReceiveFilePage() {
    ...
    return (
      <Card title="Receive File" subtitle="Open the link from your email">
        <p className="text-gray-400 text-sm mb-4">
          To download a file, use the download link sent to your email. You will
          need the link and the OTP code from the separate email.
        </p>
  ...
  return (
    <Recipient fileId={fileId} onMessage={showMessage} onReset={handleReset} />
  );
}
